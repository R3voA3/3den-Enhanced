class Enh_GridPattern
{
	...
	class Controls
	{
		...
		class NumColumnsValue: Enh_Edit
		{
			idc = 1401;
			x = 0.513125 * safezoneW + safezoneX;
			y = 0.402 * safezoneH + safezoneY;
