...
private _window = cbChecked (_display displayCtrl 1409);
private _hide = cbChecked (_display displayCtrl 1410);
...
private _unconscious = cbChecked (_display displayCtrl 1411);
