    ...
    class Attributes
    {
        ...
        class ENH_SPR
        {
            ...
            {\
                ...
                ENH_SPR_OnRespawnCode = compileFinal (_value param [4, '']);\
                ENH_SPR_Positions =\
                [\
                ...
                \
                if (isNil 'ENH_fnc_SPR_respawn') then\
                {\
                    ENH_fnc_SPR_respawn = compileFinal\
                    {\
                    ...
                    \
                    ENH_fnc_SPR_respawnTimer = compileFinal\
                    {\
