class ENH_Interface
{
    ...
    class Attributes
    {
        ...
        class ENH_ShowCustomMarkerColorAndShape: ENH_ShowPanelLeft
        {
            ...
            expression = "profileNamespace setVariable ['ENH_EditorPreferences_Interface_ShowCustomMarkerShape', _value]";
            defaultValue = "profileNamespace getVariable ['ENH_EditorPreferences_Interface_ShowCustomMarkerShape', true]";
        };
