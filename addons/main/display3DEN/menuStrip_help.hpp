...
{
  text = "$STR_ENH_MAIN_HELP_GETEXTENSIONS";
...
{
  text = "$STR_ENH_MAIN_HELP_SCRIPTINGBEGINNERS";
...
{
  text = "$STR_ENH_MAIN_HELP_MISSIONCAMPAIGNGUIDE";
...
{
  text = "$STR_ENH_MAIN_HELP_AICOMPILATION";
...
{
  text = "$STR_ENH_MAIN_HELP_COMMANDSOVERVIEW";
...
{
  text = "$STR_ENH_MAIN_HELP_FUNCTIONSOVERVIEW";
