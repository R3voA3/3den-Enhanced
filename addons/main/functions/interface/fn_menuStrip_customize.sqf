...
_ctrlTV setVariable ["fnc_toggleChildren",
{
    ...
    for "_i" from 0 to _childrenCount - 1 do
    {
        ...
        ENH_MenuStrip_Customization_HashMap set [_ctrlTV tvData _parentPath + [_i], [_state, _parentPath + [_i]]];
...
_ctrlTV ctrlAddEventHandler ["MouseButtonDown",
{
    ...
    if _inCheckboxArea then
    {
        ...
        ENH_MenuStrip_Customization_HashMap set [_ctrlTV tvData _path, [_state, _path]];
