class ENH_HoldAction: Title
{
	...
	h = 31.5 * SIZE_M * GRID_H + 75 * pixelH;
	class Controls: Controls
	{
		ATTRIBUTE_DESCRIPTION($STR_ENH_HOLDACTION_DESCRIPTION,4);
		...
		class ConditionProgressTitle: Title
		{
			...
			y = 11.5 * SIZE_M * GRID_H + 25 * pixelH;
		};
		...
		class CodeCompletionTitle: Title
		{
			...
			y = 20.5 * SIZE_M * GRID_H + 40 * pixelH;
		};
		...
		class CodeInterruptTitle: Title
		{
			...
			y = 23.5 * SIZE_M * GRID_H + 45 * pixelH;
		};
		...
		class DurationTitle: Title
		{
			...
			y = 26.5 * SIZE_M * GRID_H + 50 * pixelH;
		};
		...
		class PriorityTitle: Title
		{
			...
			y = 27.5 * SIZE_M * GRID_H + 55 * pixelH;
		};
		...
		class ShowUnconsciousTitle: Title
		{
			...
			y = 28.5 * SIZE_M * GRID_H + 60 * pixelH;
		};
		...
		class ShowWindowTitle: Title
		{
			...
			y = 29.5 * SIZE_M * GRID_H + 65 * pixelH;
		};
		...
		{
			x = ATTRIBUTE_TITLE_W * GRID_W;
			y = 30.5 * SIZE_M * GRID_H + 70 * pixelH;
			w = ATTRIBUTE_CONTENT_W * GRID_W;
			h = SIZE_M * GRID_H;
