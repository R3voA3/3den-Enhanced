...
ENH_Garrison_Buildigns_InArea = ENH_Garrison_ValidBuildings inAreaArray [getPos _object, ENH_Garrison_AreaHelper_A, ENH_Garrison_AreaHelper_B, ENH_Garrison_AreaHelper_ROTATATION_Z];
