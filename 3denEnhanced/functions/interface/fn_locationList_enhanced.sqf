...
switch (_mode) do
{
  ...
  case "init":
  {
    ...
    //Add all map objects
    [["Chapel"], "STR_ENH_LOCATIONLIST_CHAPELS"] call _fn_addMapObjects;
    [["Church"], "STR_ENH_LOCATIONLIST_CHURCHES"] call _fn_addMapObjects;
    [["FuelStation"], "STR_ENH_LOCATIONLIST_FUELSTATIONS"] call _fn_addMapObjects;
    [["Powersolar", "Powerwind", "Powerwave"], "STR_ENH_LOCATIONLIST_POWERPRODUCTION"] call _fn_addMapObjects;
    [["Shipwreck"], "STR_ENH_LOCATIONLIST_SHIPWRECKS"] call _fn_addMapObjects;
    [["Transmitter"], "STR_ENH_LOCATIONLIST_TRANSMITTERS"] call _fn_addMapObjects;
    [["Airport"], "STR_ENH_LOCATIONLIST_AIRPORTS", false] call _fn_addMapObjects;
