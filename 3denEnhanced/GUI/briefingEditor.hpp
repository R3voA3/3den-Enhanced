class ENH_BriefingEditor
{
  ...
  class ControlsBackground
  {
    ...
    class FirstParamText: ctrlStatic
    {
      ...
      x = CENTER_X - 0.5 * WINDOW_W_ATTRIBUTES * GRID_W + (25 + 40 + 1) * GRID_W;
      y = WINDOW_TOPAbs + 3 * CTRL_DEFAULT_H + 2 * GRID_H;
      w = 25 * GRID_W;
      h = CTRL_DEFAULT_H;
    };
  ...
  class Controls
  {
    class MenuStrip: ctrlMenuStrip
    {
      ...
      class Items
      {
        ...
        class ApplyTemplate
        {
          text = "$STR_ENH_BRIEFINGEDITOR_APPLYTEMPLATE";
        ...
        {
          text = "$STR_ENH_BRIEFINGEDITOR_DELETETEMPLATE";
    ...
    class SubjectValue: ctrlEdit
    {
      ...
      x = CENTER_X - 0.5 * WINDOW_W_ATTRIBUTES * GRID_W + 25 * GRID_W;
      y = WINDOW_TOPAbs + CTRL_DEFAULT_H + 6 * GRID_H;
      w = 40 * GRID_W;
      h = CTRL_DEFAULT_H;
    };
    ...
    {
      x = CENTER_X - 0.5 * (WINDOW_W_ATTRIBUTES - 2) * GRID_W;
      y = WINDOW_TOPAbs + 6 *  CTRL_DEFAULT_H + 5 * GRID_H;
      w = (WINDOW_W_ATTRIBUTES - 2) * GRID_W;
      h = WINDOW_HAbs - 10 * CTRL_DEFAULT_H - 3 * GRID_H;
      class Controls
      {
    ...
    class FirstParamValue: ctrlEdit
    {
      ...
      x = CENTER_X - 0.5 * WINDOW_W_ATTRIBUTES * GRID_W + (25 + 40 + 1 + 25 + 1) * GRID_W;
      y = WINDOW_TOPAbs + 3 * CTRL_DEFAULT_H + 2 * GRID_H;
      w = 47 * GRID_W;
      h = CTRL_DEFAULT_H;
    };
