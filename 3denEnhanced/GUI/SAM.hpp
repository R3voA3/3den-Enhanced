class ENH_SAM
{
  ...
  class Controls
  {
    ...
    class AttributeList: ctrlTree
    {
      ...
      y = WINDOW_TOP + 2 * CTRL_DEFAULT_H + 2 * GRID_H;
    ...
    class CreateTemplate: ctrlButton
    {
      ...
      x = CENTER_X - 0.5 * WINDOW_W_ATTRIBUTES * GRID_W + GRID_W;
      y = WINDOW_TOP + WINDOW_HAbs - 7 * CTRL_DEFAULT_H - 6 * GRID_H;
      w = 50 * GRID_W;
      h = CTRL_DEFAULT_H;
