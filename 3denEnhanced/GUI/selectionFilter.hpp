...
class ENH_SelectionFilter
{
  ...
  class Controls
  {
    ...
    {
      idc = 11;
      x = CENTER_X - 0.5 * 68 * GRID_W + 7 * GRID_W;
    ...
    {
      idc = 12;
      x = CENTER_X - 0.5 * 68 * GRID_W + 13 * GRID_W;
    ...
    {
      idc = 13;
      x = CENTER_X - 0.5 * 68 * GRID_W + 19 * GRID_W;
    ...
    {
      idc = 14;
      x = CENTER_X - 0.5 * 68 * GRID_W + 25 * GRID_W;
    ...
    {
      idc = 15;
      x = CENTER_X - 0.5 * 68 * GRID_W + 31 * GRID_W;
    ...
    {
      idc = 16;
      x = CENTER_X - 0.5 * 68 * GRID_W + 37 * GRID_W;
    ...
    {
      idc = 17;
      x = CENTER_X - 0.5 * 68 * GRID_W + 43 * GRID_W;
    ...
    {
      idc = 1;
      x = CENTER_X - 0.5 * 68 * GRID_W + 56 * GRID_W;
    ...
    {
      idc = -1;
      x = CENTER_X - 0.5 * 68 * GRID_W + 62 * GRID_W;
