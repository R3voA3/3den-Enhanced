class ENH_3DENRadio
{
  ...
  DISABLE_BACKGROUND
    ...
    class CurrentSong: CurrentSongText
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 10 * GRID_W;
      w = (WINDOW_W - 10) * GRID_W;
    };
  };
  class Controls
  {
    ...
    class ToggleRadio: ctrlButtonPictureKeepAspect
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + GRID_W;
    ...
    class VolumeIcon: ctrlStaticPictureKeepAspect
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 7 * GRID_W;
	  y = WINDOW_TOP + WINDOW_HAbs - 26 * GRID_H;
      w = 5 * GRID_W;
      h = 5 * GRID_H;
    };
    class Volume: ctrlXSliderH
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 13 * GRID_W;
      y = WINDOW_TOP + WINDOW_HAbs - 26 * GRID_H;
      w = 30 * GRID_W;
      h = 5 * GRID_H;
      sliderRange[] = {0, 1.5};
    ...
    class Help: VolumeIcon
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 44 * GRID_W;
      tooltipMaxWidth = 1;
    };
    class SearchEdit: ctrlEdit
    {
      ...
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 50 * GRID_W;
      y = WINDOW_TOP + WINDOW_HAbs - 26 * GRID_H;
      w = 30 * GRID_W;
      h = 5 * GRID_H;
    ...
    class SearchIcon: VolumeIcon
    {
      ...
      tooltip = "";
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 80 * GRID_W;
    };
    class Group: ctrlControlsGroup
    {
      x = CENTER_X - (WINDOW_W * 0.5) * GRID_W + 86 * GRID_W;
      y = WINDOW_TOP + WINDOW_HAbs - 26 * GRID_H;
      w = 80 * GRID_W;
      h = 5 * GRID_H;
      class Controls
    ...
    {
      x = CENTER_X + 0.5 * WINDOW_W * GRID_W - 26 * GRID_W;
      y = WINDOW_TOP + WINDOW_HAbs - 26 * GRID_H;
      w = 25 * GRID_W;
      h = 5 * GRID_H;
    };
