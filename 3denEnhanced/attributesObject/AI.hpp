class ENH_AI
{
    ...
    {
      displayName = "Skill Settings";
      //description = "Various AI Skill Settings. See <a href='https://community.bistudio.com/wiki/Arma 3 AI Skill'>Arma 3 AI Skill</a> to learn more."
    ...
    class ENH_AI_Features_Description: ENH_AI_Skill_Description
    {
      ...
      description = "Disable AI Features. See <a href='https://community.bistudio.com/wiki/disableAI'>disable AI command documentation</a> to learn more."
			data = "AttributeSystemSubcategory";
		};
    class ENH_Move
		{
